...
const PortfolioCard = (
  ...
  return (
    <div className="w-full h-full overflow-y-hidden bg-gray-100 text-gray-900">
      <Header />

      {/* Navbar options */}
      <div className="w-full text-sm md:text-lg z-10 flex gap-4 px-2 md:px-10 py-3 bg-white shadow-md">
        <button
          className={`cursor-pointer px-2 md:px-3 py-1 rounded-sm transition-colors duration-300 ${
            navbarDesign === "NavbarDesign1"
      ...
      <div className="w-full h-full px-2 absolute top-36 overflow-y-hidden py-2 md:py-3">
        <div className="w-full h-full flex flex-col md:flex-row">
          <div className="w-full md:w-1/2 h-[26.8rem] md:h-full overflow-y-scroll border py-2 px-2 md:px-4 my-2 mx-2 md:my-0 rounded-lg bg-white shadow-lg">
            <div className="flex justify-between2 gap-1 border p-1 rounded-md text-gray-800 text-sm items-center my-2">
              <div
                className="p-2 rounded-md bg-blue-400 cursor-pointer hover:scale-[1.02] border transition-transform duration-300"
            ...
            <div className="flex gap-1 border p-1 rounded-md text-gray-800 text-sm items-center my-2">
              <div
                className="p-2 rounded-md bg-blue-400 cursor-pointer hover:scale-[1.02] border transition-transform duration-300"
            ...
            <div className="flex gap-1 border p-1 rounded-md justify-start text-gray-800 text-sm items-center my-2">
              <div
                className="p-2 rounded-md bg-blue-400 cursor-pointer hover:scale-[1.02] border transition-transform duration-300"
          ...
          <div className="p-3 w-full md:w-1/2 h-[26.8rem] md:h-full overflow-y-scroll border py-2 px-2 md:px-4 mb-2 rounded-lg bg-white shadow-lg">
