            ...
            <div className='w-full h-1/3 bg-gray-900'>
                <div className='w-full h-fit text-white'>
                    ...
                    <div className='py-6 px-8' style={{ fontFamily: "Raleway" }}>
                        <div className='text-3xl font-extrabold p-1'>Welcome 👋</div>
                        <div className='text-2xl font-medium px-1 pt-1'>Computer Science Engineering</div>
                        <div className='text-2xl font-medium px-1 pb-2'>12208432</div>
                    </div>
                </div>
            </div>
