...
const NavbarDesign1 = ({
  ...
  return (
    <div className='fixed top-0 left-0 z-20 w-full rounded-full flex justify-center font-Manrope' >
      <div className='w-full md:w-3/3 flex justify-between items-center mt-4 mx-4 md:mx-8 rounded-md p-2 md:p-3 text-sm md:text-lg text-white bg-purple-600 font-semibold'> 
